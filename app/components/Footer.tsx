...
function Footer() {
  return (
    <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-white">
      <div className="text-center border-t-2 mb-3">
        <div>
          <a
            className="flex-none text-xl font-semibold text-black mt-3"
            href="#"
            aria-label="Brand"
          >
            Brick Ventures
